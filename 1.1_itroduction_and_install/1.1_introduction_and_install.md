...
* Python IDLE: Bước đầu tiên cần vào trình duyệt web như Google, tìm install python, nhấp vào download (chú ý: nên chọn phiên bản phù hợp với máy tính):
  ...
  ![Picture2](https://github.com/HoVanNguyen09/self-learning-Python/assets/18c8a92d-6ecf-4d94-a60c-fcdd9c45d45d)
...
![Picture7](https://github.com/HoVanNguyen09/self-learning-Python/assets/8e0b3951-96c7-4068-9b3f-0a56cd7c3c2f)
...
*	Cài đặt Visual Studio Code:
  ...
  ![Picture10](https://github.com/HoVanNguyen09/self-learning-Python/assets/ca1853ed-2418-4fe8-9b14-cbff38fe8328)
